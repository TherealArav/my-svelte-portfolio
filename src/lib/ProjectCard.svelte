...
<li>
    ...
    <a
        href={href}
        class="group -ml-4 flex flex-col gap-4 rounded-xl p-4 transition-colors hover:bg-slate-100 focus:outline-none focus:ring-4 focus:ring-teal-500 dark:hover:bg-slate-900/80"
        target="_blank"
